...
async function iterate_component(req) {
  ...
  const components_list = fs.readdirSync(`./../../../opt/render/.toolzz-ui-app/generated/components/${req.componentId}`).filter(e=>e.endsWith(`.json`)).sort()
  const previous_component = {
    ...JSON.parse( fs.readFileSync(`./../../../opt/render/.toolzz-ui-app/generated/components/${req.componentId}/${components_list.slice(-1)[0]}`,'utf-8') ),
    code: fs.readFileSync(`./../../../opt/render/.toolzz-ui-app/generated/components/${req.componentId}/${components_list.slice(-1)[0].split('.')[0]}.tsx`,'utf-8'),
  }
  const first_component = {
    ...JSON.parse( fs.readFileSync(`./../../../opt/render/.toolzz-ui-app/generated/components/${req.componentId}/${components_list[0]}`,'utf-8') ),
    code: fs.readFileSync(`./../../../opt/render/.toolzz-ui-app/generated/components/${req.componentId}/${components_list[0].split('.')[0]}.tsx`,'utf-8'),
  }
