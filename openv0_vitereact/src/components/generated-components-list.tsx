...
import generatedComponents from '../../../../render/.toolzz-ui-app/generated_components_dump.json';
...
export default function GeneratedComponentsList() {
  ...
  useEffect(() => {
    ...
    try {
      fetch(`${import.meta.env.VITE_API_URL}/component/ping/?from=Home (Browse Components)`);
    }catch(e){
      console.log(e);
    }
